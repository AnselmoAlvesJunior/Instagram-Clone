...
import com.parse.starter.util.ParseErro;
...
public class CadastroActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textoUsuario=(EditText) findViewById(R.id.textUsuarioId);
        textoEmail=(EditText) findViewById(R.id.textEmailId);
        textoPassword=(EditText) findViewById(R.id.textPasswordId);
        botaoCadastrar=(Button) findViewById(R.id.btn_logar);
        facaLogin=(TextView) findViewById(R.id.text_facaLogin);
    ...
    private void cadastrarUsuario(){
        ...
        usuario.setPassword(textoPassword.getText().toString());
